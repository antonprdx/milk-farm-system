...
export let tdHidden = 'px-3 py-2 text-sm text-slate-700 dark:text-slate-300 whitespace-nowrap hidden md:table-cell';
export let thHidden = 'px-3 py-2 text-left text-xs font-medium text-slate-500 dark:text-slate-400 uppercase tracking-wider hidden md:table-cell';
