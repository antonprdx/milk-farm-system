...
async fn test_create_calving(pool: sqlx::PgPool) {
    ...
    let req = auth_request_with_body("POST", "/api/reproduction/calvings", &admin_token(), json!({
        "animal_id": animal_id,
...
async fn test_get_calving_by_id(pool: sqlx::PgPool) {
    ...
    let create_req = auth_request_with_body("POST", "/api/reproduction/calvings", &admin_token(), json!({
        "animal_id": animal_id,
        "calving_date": "2024-06-01"
    }));
    ...
    let get_req = auth_request("GET", &format!("/api/reproduction/calvings/{}", id), &admin_token());
...
async fn test_create_insemination(pool: sqlx::PgPool) {
    ...
    let req = auth_request_with_body("POST", "/api/reproduction/inseminations", &admin_token(), json!({
        "animal_id": animal_id,
...
async fn test_create_pregnancy(pool: sqlx::PgPool) {
    ...
    let req = auth_request_with_body("POST", "/api/reproduction/pregnancies", &admin_token(), json!({
        "animal_id": animal_id,
...
async fn test_create_heat(pool: sqlx::PgPool) {
    ...
    let req = auth_request_with_body("POST", "/api/reproduction/heats", &admin_token(), json!({
        "animal_id": animal_id,
...
async fn test_create_dryoff(pool: sqlx::PgPool) {
    ...
    let req = auth_request_with_body("POST", "/api/reproduction/dryoffs", &admin_token(), json!({
        "animal_id": animal_id,
